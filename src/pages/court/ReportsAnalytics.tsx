...
// Colors for charts
const COLORS = ['#4F6AFF', '#FF6E36', '#36D399', '#FFBD49', '#8257E5', '#F688B1'];
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <h1 className="text-2xl font-bold text-forensic-800">Reports & Analytics</h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="bg-forensic-court hover:bg-forensic-court/90" onClick={() => handleDownloadReport('Full Analytics')}>
      ...
      <Tabs defaultValue="cases">
        ...
        <TabsContent value="cases" className="mt-6 space-y-6">
            ...
            <Card className="md:col-span-2">
                ...
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="submitted" stroke="#4F6AFF" name="Submitted Cases" activeDot={{ r: 8 }} />
                      <Line type="monotone" dataKey="resolved" stroke="#36D399" name="Resolved Cases" />
                    </RechartsLineChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
                <p className="text-sm text-forensic-600">
                  Total Cases: {monthlyCases.reduce((sum, item) => sum + item.submitted, 0)}
                </p>
                <Button variant="outline" size="sm" onClick={() => handleDownloadReport('Case Trends')}>
                  <Download className="h-4 w-4 mr-2" />
                  Download Chart
                </Button>
              </CardFooter>
          ...
          <Card>
            ...
            <CardFooter className="flex justify-between">
              <p className="text-sm text-forensic-600">
                Total Cases: {caseStatus.reduce((sum, item) => sum + item.value, 0)}
              </p>
              <Button variant="outline" size="sm" onClick={() => handleDownloadReport('Case Status')}>
                <Download className="h-4 w-4 mr-2" />
                Download Chart
              </Button>
            </CardFooter>
        ...
        <TabsContent value="evidence" className="mt-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="md:col-span-2">
                ...
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="uploaded" stroke="#FF6E36" name="Uploaded Evidence" activeDot={{ r: 8 }} />
                      <Line type="monotone" dataKey="verified" stroke="#36D399" name="Verified Evidence" />
                    </RechartsLineChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
                <p className="text-sm text-forensic-600">
                  Total Evidence: {monthlyEvidence.reduce((sum, item) => sum + item.uploaded, 0)}
                </p>
                <Button variant="outline" size="sm" onClick={() => handleDownloadReport('Evidence Trends')}>
                  <Download className="h-4 w-4 mr-2" />
                  Download Chart
                </Button>
              </CardFooter>
          ...
          <Card>
            ...
            <CardFooter className="flex justify-between">
              <p className="text-sm text-forensic-600">
                Total Items: {verificationStatus.reduce((sum, item) => sum + item.value, 0)}
              </p>
              <Button variant="outline" size="sm" onClick={() => handleDownloadReport('Verification Status')}>
                <Download className="h-4 w-4 mr-2" />
                Download Chart
              </Button>
            </CardFooter>
        ...
        <TabsContent value="users" className="mt-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="md:col-span-2">
                ...
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="users" stroke="#8257E5" name="Active Users" activeDot={{ r: 8 }} strokeWidth={2} />
                    </RechartsLineChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
                <p className="text-sm text-forensic-600">
                  Current Active Users: {monthlyActiveUsers[monthlyActiveUsers.length - 1].users}
                </p>
                <Button variant="outline" size="sm" onClick={() => handleDownloadReport('User Trends')}>
                  <Download className="h-4 w-4 mr-2" />
                  Download Chart
                </Button>
              </CardFooter>
          ...
          <Card>
            ...
            <CardFooter className="flex justify-between">
              <p className="text-sm text-forensic-600">
                Total Activities: {userActivity.reduce((sum, item) => sum + item.value, 0)}
              </p>
              <Button variant="outline" size="sm" onClick={() => handleDownloadReport('User Activity')}>
                <Download className="h-4 w-4 mr-2" />
                Download Chart
              </Button>
            </CardFooter>
